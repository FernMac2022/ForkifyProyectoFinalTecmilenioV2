...
class RecipeView extends View {
  ...
  _formatQuantity(quantity) {
    ...
    let symbol = '';
    for (const [key, display] of fractions) {
      ...
      <div class="recipe__details">
        ...
        <div class="recipe__info">
          ...
          <div class="recipe__info-buttons">
            <button class="btn--tiny btn--update-servings" data-update-to="${this._data.servings - 1}" aria-label="Decrease servings">
              <svg><use href="${icons}#icon-minus-circle"></use></svg>
            </button>
            <button class="btn--tiny btn--update-servings" data-update-to="${this._data.servings + 1}" aria-label="Increase servings">
        ...
        <button class="btn--round btn--bookmark" aria-label="Bookmark recipe">
          <svg>
